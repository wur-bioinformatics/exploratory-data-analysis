...
//| fig-cap: Correlation is undericted, causation implies a direction.
digraph CorrelationVsCausation {
  graph [
  ...
  subgraph cluster_correlation {
    ...
    Xc -> Yc [dir=none label="association"]
  }

  subgraph cluster_causation {
    label="Causation"
    style=solid
...
__Take home message__: A correlation coefficient is evidence, not a verdict. Strong scientific arguments combine visual inspection, use appropriate methods, consider effect size, and include biological reasoning.
:::
