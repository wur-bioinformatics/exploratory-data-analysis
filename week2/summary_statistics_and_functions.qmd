...
### What is a function?
A function can be concisely described as a __reusable piece of code__. Some clear examples of this are the functions you have used from some of the packages you used (e.g. the `read.csv()` or `ggplot()` functions). 
