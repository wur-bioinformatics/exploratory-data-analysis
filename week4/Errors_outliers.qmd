---
title: "Errors, outliers and simulations"
author: "Peter Bourke"
---
...
We will also be dealing with simulations; initially, using a [simulator](%22https://shiny.wur.nl/content/937deca7-466c-4887-987e-1bb952bc8efb%22) to generate datasets with errors in them. You will have to don your detectives' cap to figure out the error rates in the data.
...
The dataset that resulted is available to download from [Brightspace](%22https://brightspace.wur.nl/d2l/home/336819%22) under Content -\> Week 4. The filename is "tomato_salinity.csv".

Downloaded this file and save it to your working directory. Let's read in the file and check its dimension and structure:
...
If you need some reminders on what terms like "median" and "quantile" mean, you can also check back to the [notes from week 2](%22https://wur-bioinformatics.github.io/exploratory-data-analysis/week2/summary_statistics_and_functions.html%22).
...
Finally, it may dawn on you that you estimated trait means and genetic correlations *before* identifying potential outliers. This is OK, but perhaps the outliers introduced some bias, in which case simply taking the mean of the data might not be very accurate. 

I leave this up to you to think about.
