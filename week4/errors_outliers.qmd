...
We will also be dealing with simulations; initially, using a [simulator](https://shiny.wur.nl/EDA_R_sim/) to generate datasets with errors in them. You will have to don your detectives' cap to figure out the error rates in the data.
