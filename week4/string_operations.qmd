...
::: callout-note
You have probably already encountered the `apply` family of functions in earlier weeks.
...
## Unexpected data formats and `readLines()`
