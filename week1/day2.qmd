...
Before we start, make sure you have set the work directory and have the following packages ready: {tidyverse} and {readxl}. Of course you also need to activate them. If you're not sure how, check [Chapter 1](/week1/day1.qmd).
...
Now save the plot, check back at [Chapter 1](/week1/day1.qmd). Use a graphical device to save the plot with dimensions of 7 (width) by 4 (height) inch.
...
### Some reading
In part, this assignment was inspired by a paper in the journal Genome Biology, by Itai Yanai and Martin Lercher[@Yanai2020]. Read this paper as food for thought about what we covered today in p-value testing and its role in data analysis. This editorial paper is part of an interesting series of editorials about data science in biology: [Night science](https://link-springer-com.ezproxy.library.wur.nl/collections/cejajaicde)[@Yanai2019].
