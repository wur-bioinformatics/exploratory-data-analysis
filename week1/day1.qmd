...
For the tutorials, assignments, and exams, it's important that you built a file documenting your code. On the first two days, we will provide a full-scale template for you, that you can find [here](week1/day1_student_notebook.qmd) This Quarto markdown template you can open into the text editor in R-studio.
