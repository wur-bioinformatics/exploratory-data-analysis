...
2.  For [Chapter 2]((week1/day2.qmd)) you have your own, personal dataset based on [@Schaveling2026].
3.  For [Chapter 3]((week1/day3.qmd)), we start with a shared dataset[@Willig2023]. For the assignment, you will also have your own, personal dataset[@Willig2023]. This dataset you find in a folder under your own name.
