...
::: {.callout-note appearance="simple"}
We covered these functions in [Chapter 1](/week1/day1.qmd) and [Chapter 2](/week1/day2.qmd)) under the heading Inspecting data.
:::
...
::: {.callout-note appearance="simple"}
We covered these functions in [Chapter 2](/week1/day2.qmd)) when combining the four objects.
:::
