...
>>>>>>> cb732e0b1bdfb241dfd57268205c105d50c21708
...
Also, you should provide a conclusion about the *biological interpretation* of the data. The exercises below take you through the assignment step-by step. Make sure that for the R steps you include code chunks (those started by \`\`\`{r} and ended by ```). If you print figures or execute functions within these blocks, the output will be included in the .html.
